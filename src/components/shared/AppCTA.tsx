...
export function AppCTA({
  ...
  if (variant === "banner") {
    return (
      <div className="bg-accent-blue">
        <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row items-center gap-4 sm:gap-8 px-4 md:px-14 py-6 sm:py-8">
  ...
  return (
    <div className="bg-accent-blue">
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 px-4 md:px-14 py-10 md:py-14">
